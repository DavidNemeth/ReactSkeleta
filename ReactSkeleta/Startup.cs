...
using ReactSkeleta.Extensions.Microsoft.Extensions.DependencyInjection;
using ReactSkeleta.Infrastructure;
using ReactSkeleta.Services;
using Serilog;

namespace ReactSkeleta
{
